...
public class Paciente implements Serializable {
    ...
    //Set<AntecedenteFamiliar> antecedentes, Set<Cita> citas, Usuario usuario, Set<Consulta> consultas
    public Paciente(String nombre, String telCasa, String telCel, Date fechaIngreso, String enfermedades, String cirugias, String alimentosNoGustan, String alergiaAlimentos) {
        super();
        this.nombre = nombre;
